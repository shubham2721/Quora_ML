...
def inferencing(questionid1, questionid2, question1, question2):
    ...
    log_pred, log_pred_proba, svm_pred, svm_pred_proba, dt_pred, dt_pred_proba = mip.model_implentation(result)
    
    return log_pred, log_pred_proba, svm_pred, svm_pred_proba, dt_pred, dt_pred_proba
